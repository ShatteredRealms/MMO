...
public:
	...
	UFUNCTION(BlueprintCallable, BlueprintPure, Category="CommonUser | Auth")
	TMap<FString, FString> CreateAuthMetaData(int32 PlayerIndex) const;

	UFUNCTION(BlueprintCallable, BlueprintPure, Category="CommonUser | Auth")
	int32 GetPlayerIndexFromAuthToken(FString AuthToken) const;

	UFUNCTION(BlueprintCallable)
	FString GetUserId(int32 PlayerIndex);
