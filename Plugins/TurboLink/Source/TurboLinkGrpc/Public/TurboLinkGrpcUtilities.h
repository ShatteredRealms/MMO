...
public:
	...
	{
		Value = FString::Printf(TEXT("%u"), UInt32.Value);
	}
	...
	UFUNCTION(BlueprintPure, Category = "TurboLink", DisplayName = "Create Auth Meta Data")
	static TMap<FString, FString> CreateAuthMetaData(const FString& Token)
	{
		return {{TEXT("authorization"), TEXT("Bearer ") + Token}};
	};
};
