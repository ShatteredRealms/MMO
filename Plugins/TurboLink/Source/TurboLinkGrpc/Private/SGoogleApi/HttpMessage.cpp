...
DEFINE_JSON_FUNCTIONS(FGrpcGoogleApiHttp, ::google::api::Http)
DEFINE_JSON_FUNCTIONS(FGrpcGoogleApiHttpRule, ::google::api::HttpRule)
DEFINE_JSON_FUNCTIONS(FGrpcGoogleApiCustomHttpPattern, ::google::api::CustomHttpPattern)
