...
void UHealthService::CallHealth(const FGrpcGoogleProtobufEmpty& Request, FHealthResponseLambda ResponseLambda, TMap<FString, FString>& MetaData)
{
	...
	InnerClient->Health(lambdaWrapper->Handle, Request, MetaData);
}
