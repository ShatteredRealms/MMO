...
protected:	
	...
	UFUNCTION()
	void OnGetCharacterResponse(FGrpcContextHandle Handle, const FGrpcResult& GrpcResult, const FGrpcSroCharacterCharacter& Response);

	UFUNCTION()
	void OnVerifyConnection(const FUniqueNetIdRepl& UniqueId, const FGrpcSroTargetId& TargetId, bool bWasSuccessful);

	TMap<FUniqueNetIdRepl, FGrpcSroCharacterCharacter> CachedCharacterData;
	TMap<FString, FUniqueNetIdRepl> PendingConnections;
	TMap<FUniqueNetIdRepl, FOnPreLoginCompleteDelegate> PendingVerifications;
